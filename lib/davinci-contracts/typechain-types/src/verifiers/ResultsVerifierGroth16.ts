...
export interface ResultsVerifierGroth16Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "compressProof"
      | "provingKeyHash"
      | "verifyCompressedProof"
      | "verifyProof(uint256[8],uint256[2],uint256[2],uint256[9])"
  ...
  encodeFunctionData(
    functionFragment: "verifyProof(uint256[8],uint256[2],uint256[2],uint256[9])",
    values: [
      BigNumberish[],
      [BigNumberish, BigNumberish],
      [BigNumberish, BigNumberish],
...
export interface ResultsVerifierGroth16 extends BaseContract {
  connect(runner?: ContractRunner | null): ResultsVerifierGroth16;
  waitForDeployment(): Promise<this>;

  interface: ResultsVerifierGroth16Interface;
  ...
  "verifyProof(uint256[8],uint256[2],uint256[2],uint256[9])": TypedContractMethod<
    [
      proof: BigNumberish[],
      commitments: [BigNumberish, BigNumberish],
      commitmentPok: [BigNumberish, BigNumberish],
  ...
  >;
  getFunction(
    nameOrSignature: "verifyProof(uint256[8],uint256[2],uint256[2],uint256[9])"
  ): TypedContractMethod<
    [
      proof: BigNumberish[],
      commitments: [BigNumberish, BigNumberish],
